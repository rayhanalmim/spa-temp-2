...
const Header = () => {
    ...
    return (
        <div>
                                ...
                                <ul className="flex space-x-4">
                                    <li>
                                        <a href="/en" className="flex items-center">
                                            ...
                                            <span className="ml-4 text-sm font-semibold">Global Home</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
            ...
            {/*Drawer Menu */}
            <div ref={drawerRef} className={`fixed top-0 right-0 h-full w-full lg:w-[800px] z-50 bg-white shadow-lg transform transition-transform duration-300 ${isMobileMenuOpen ? 'translate-x-0' : 'translate-x-full'}`}>
                        ...
                        <div className="">
                            ...
                            <div className="list-wrapper mt-6 space-y-2  max-h-[500px] overflow-auto scrollbar-hide">
                                {[
                                    ...
                                    >
                                        <span className="block font-semibold text-[#b9984c]">{location.name}</span>
