...
const HeaderText = () => {
    return (
        <div className='py-7 md:py-10 bg-[#F5F5F5] px-4 md:px-10 lg:px-12'>
            <h3 className='w-full md:w-3/4 text-xl md:text-3xl leading-10' style={{ fontFamily: 'Times New Roman, Times, serif' }}>
